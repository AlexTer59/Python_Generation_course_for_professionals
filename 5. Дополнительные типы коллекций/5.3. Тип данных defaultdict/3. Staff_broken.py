...
Higgins, James Wilkins, Jane Jackson, John Watts, Kay Scott, Kimberly Reynolds, Linda Hudson, Michelle Wright,
...
for employee in sorted(staff_broken):
    staff[employee[0]].add(employee[1])

[print(f'{k}: {", ".join(sorted(v))}') for k, v in staff.items()]
