...
with ZipFile('2. workbook.zip') as zip_file:
    print(f'Объем исходных файлов: {sum((i.file_size for i in zip_file.infolist()))} байт(а)')
    print(f'Объем сжатых файлов: {sum((i.compress_size for i in zip_file.infolist()))} байт(а)')
